...
function preload(){
	img = loadImage("roadToParis/data/World_Projected_WGS1984_Short-03-01.png");
	imgPrecipitation = loadImage("roadToParis/data/icon_precipitation/icon_precipitation.svg");
	imgTemperature = loadImage("roadToParis/data/icon_temperature/icon_temperature.svg");
	imgPlant = loadImage("roadToParis/data/icon_plant/icon_plant.svg");
	imgSociety = loadImage("roadToParis/data/icon_society/icon_society.svg");
	imgAnimal = loadImage("roadToParis/data/icon_bear/icon_bear.svg");
	imgOcean = loadImage("roadToParis/data/icon_shark/icon_shark.svg");
	events = loadTable('roadToParis/data/ENSO_Infographic_Data_Clean.csv');
}
